...
client = InferenceHTTPClient(
    ...
    api_key="ZRfC4ieSaVozCQvML3U8"
)

indian_workflows = [
    {"workspace": "fooddetection-fth2a", "workflow_id": "custom-workflow-1"},
    {"workspace": "fooddetection-fth2a", "workflow_id": "custom-workflow-2"},
    {"workspace": "fooddetection-fth2a", "workflow_id": "custom-workflow-3"}
]
...
if not MODEL_PATH.exists():
    print(f"[INFO] Downloading YOLO model to {MODEL_PATH}...")
    try:
        yolo_model = YOLO('yolov8n.pt')
        print(f"[INFO] YOLO nano model loaded successfully")
...
NUTRITIONIX_APP_ID = "638e850a"
NUTRITIONIX_API_KEY = "73d48f26689152e1e7b1967d650e05b0"
NUTRITIONIX_URL = "https://trackapi.nutritionix.com/v2/natural/nutrients"

COHERE_API_KEY = "I5QR9SWlFPMEww75t4GKJrADwtOXZxa4oV1T5fYO"
